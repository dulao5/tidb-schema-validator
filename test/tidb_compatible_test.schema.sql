...
CREATE TABLE products (
  ...
  name VARCHAR(255) CHARACTER SET latin2 COLLATE utf8mb4_bin NOT NULL,
  name2 VARCHAR(255) CHARACTER SET utf8 COLLATE utf8mb4_bin NOT NULL,
  name3 VARCHAR(255) CHARACTER SET utf8mb3 COLLATE utf8mb4_bin NOT NULL,
  description TEXT,
